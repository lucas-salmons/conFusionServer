...
dishRouter.route('/:dishId/comments')
    ...
    .post(cors.corswithOptions, authenticate.verifyUser, (req, res, next) => {//any verified user may comment on a dish
        Dishes.findById(req.params.dishId)
            .then((dish) => {
                if (dish != null) {
    ...
    .delete(cors.corswithOptions, authenticate.verifyUser, authenticate.verifyAdmin, (req, res, next) => {//only admins can delete all comments
        Dishes.findById(req.params.dishId)
            .then((dish) => {
                if (dish != null) {
...
dishRouter.route('/:dishId/comments/:commentId')
    ...
    .delete(cors.corswithOptions, authenticate.verifyUser, (req, res, next) => {//auth verifyUser as admin priv are not necessary for ..comments/:commentId endpoint
        Dishes.findById(req.params.dishId)
            .then((dish) => {
                if (dish != null && dish.comments.id(req.params.commentId) != null) {
